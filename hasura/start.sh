...
socat TCP-LISTEN:9695,fork,reuseaddr,bind=hasura-cli TCP:127.0.0.1:9695 &
socat TCP-LISTEN:9693,fork,reuseaddr,bind=hasura-cli TCP:127.0.0.1:9693 &
{
    # Apply migrations
